...
startReactor = {
    ...
    audio: {
        ...
        // Transforma a string em objeto para achar o audio
        loadAudio(filename) {
        ...
        return new Promise(resolve => {
            ...
            Array.prototype.forEach.call(memory, (element) => {
                    ...
                    if (playerMemory.classList.contains("playerActive")) {
                        ...
                        console.log("O valor do elemento clicado e: " + element.dataset.memory)
    ...
    play(index) {
        ...
        if (startReactor.isTheRightCombination(startReactor.playerCombination.length)) {
            ...
            document.getElementById("title").textContent = "Voce e o impostor"
            setTimeout(() => {
                document.getElementById("title").textContent = "Iniciar Reator"
                startReactor.start()
            }, 1400)
            return
        }
